      ...
      <div className="container">
        ...
        <div className="hidden h-16 items-center justify-between md:flex">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Button
              ...
              className="inline-flex gap-1.5 border-border/60 bg-muted/40 px-2 sm:px-3"
        ...
        <div className="space-y-2 py-2 md:hidden">
          <div className="flex items-center justify-between">
            ...
            <Link to="/dashboard" className="flex items-center gap-2">
              <img src="/TossUp-logo.png" alt="TossUp" className="h-10 w-10 rounded-full object-cover" />
              <span className="font-brand text-2xl leading-none tracking-wide gradient-text">
                TossUp
              </span>
            </Link>
          ...
          <div className="flex items-center justify-between rounded-xl border border-border/40 bg-muted/25 px-3 py-2">
            <div className="flex items-center gap-1.5 rounded-full bg-background/70 px-3 py-1.5">
              ...
              <span className="text-xs font-bold leading-none text-foreground tabular-nums">
                {user?.coins?.toLocaleString() ?? 0}
              </span>
            </div>
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                size="icon"
                onClick={handleThemeToggle}
                className="h-9 w-9 border-border/60 bg-background/60"
                title={`Switch theme (current: ${activeThemeLabel})`}
              >
