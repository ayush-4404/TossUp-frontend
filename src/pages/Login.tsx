      ...
      >
        <div className="glass-card rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            <img src="/TossUp-logo.png" alt="TossUp" className="h-24 w-24 sm:h-28 sm:w-28 rounded-full object-cover mx-auto mb-3 border border-border/50" />
            <h1 className="font-brand text-4xl gradient-text tracking-wide">TossUp</h1>
